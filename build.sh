...
then
  ...
  [ -f TinyTeX-1-v2022.04.04.tar.xz ] || wget -c --timeout=30 --tries=3 "https://www.giuspen.net/software/TinyTeX-1-v2022.04.04.tar.xz" || echo "!! TinyTeX download failed — AppImage will lack LaTeX support !!"
