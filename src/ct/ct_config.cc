...
void CtConfig::_populate_keyfile_from_data()
{
    ...
    _uKeyFile->set_boolean(_currentGroup, "show_node_name_label", showNodeNameLabel);
    ...
    _uKeyFile->set_boolean(_currentGroup, "local_history_enabled", localHistoryEnabled);
    _uKeyFile->set_integer(_currentGroup, "local_history_max_use_days", localHistoryMaxUseDays);
    _uKeyFile->set_integer(_currentGroup, "local_history_replay_cycles", localHistoryReplayCycles);
    ...
    _uKeyFile->set_integer(_currentGroup, "table_row_height", tableRowHeightDefault);
    ...
    _uKeyFile->set_boolean(_currentGroup, "node_size", nodeSizeOn);
    _uKeyFile->set_boolean(_currentGroup, "subnodes", subnodesOn);
...
void CtConfig::_populate_data_from_keyfile()
{
    ...
    _populate_bool_from_keyfile("show_node_name_label", &showNodeNameLabel);
    ...
    _populate_bool_from_keyfile("local_history_enabled", &localHistoryEnabled);
    _populate_int_from_keyfile("local_history_max_use_days", &localHistoryMaxUseDays);
    _populate_int_from_keyfile("local_history_replay_cycles", &localHistoryReplayCycles);
    ...
    _populate_int_from_keyfile("table_row_height", &tableRowHeightDefault);
    ...
    _populate_bool_from_keyfile("node_size", &nodeSizeOn);
    _populate_bool_from_keyfile("subnodes", &subnodesOn);
